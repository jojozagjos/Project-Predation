...
struct CreatureSnapshot
{
    ...
    // What it is clinging to -- the floor, a wall, the ceiling, or falling from it (Creature::Cling) --
    // and, up a wall, which way the wall faces. Its position is where its feet are, wherever that is.
    uint8_t cling = 0;
    float wallYaw = 0.0f;
};
