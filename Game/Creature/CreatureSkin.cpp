...
float RoundCone(const glm::vec3& p, const glm::vec3& a, const glm::vec3& b, float r1, float r2)
{
...
float Ellipsoid(const glm::vec3& local, const glm::vec3& radii)
{
...
float SmoothCut(float body, float cut, float k)
{
...
float Hash(int x, int y, int z, uint32_t seed)
{
...
float ValueNoise(const glm::vec3& p, uint32_t seed)
{
...
float Fbm(const glm::vec3& p, uint32_t seed, int octaves)
{
    float sum = 0.0f;
